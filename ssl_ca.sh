...
openssl rsa -in "ssl/localhost.secured.key" -out "localhost.key"
...
openssl ca -verbose -config myssl.cnf -extensions v3_ca -out "ssl/localhost.cert" -keyfile CA/ca.key -infiles "ssl/localhost.csr"
